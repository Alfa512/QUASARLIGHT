    ...
    return {
        init: function () {
            ...
            $('#form-login').validate({
                ...
                messages: {
                    'login-email': 'Пожалуйста, введите ваш Email',
                    'login-password': {
                        required: 'Пожалуйста, укажите пароль',
                        minlength: 'Ваш пароль должен быть длиной не менее 6-ти символов'
                    }
                }
            });
            ...
            $('#form-reminder').validate({
                ...
                messages: {
                    'reminder-email': 'Пожалуйста, введите ваш Email'
                }
            });
            ...
            $('#form-register').validate({
                ...
                messages: {
                    ...
                    'register-lastname': {
                        ...
                        minlength: 'Пожалуйста, введите вашу фамилию'
                    },
                    'register-email': 'Пожалуйста, введите ваш Email',
                    'register-password': {
                        required: 'Пожалуйста, укажите пароль',
                        minlength: 'Ваш пароль должен быть длиной не менее 6-ти символов'
                    },
